...
CREATE TABLE REGISTERED_CLASSES(
    ...
    DEPARTMENT VARCHAR(4) REFERENCES COURSE(DEPARTMENT_NAME) NOT NULL,
    CLASS_NUMBER NUMBER(4) PRIMARY KEY REFERENCES COURSE(CLASS_NUMBER)
);
...
CREATE TABLE DEPARTMENT(
    DEPARTMENT VARCHAR(4) REFERENCES COURSE(DEPARTMENT_NAME) PRIMARY KEY ,
